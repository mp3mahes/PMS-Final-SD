...
$catArray = $db_handle->runQuery("SELECT category FROM categories WHERE type='Nutrition'");
$i = 0;
...
<br>
<div id = "outmap">
	<h1 style="color:white">  Nutritious Places Near You </h1>
</div>
<div style="width: 100%; overflow: auto;">
	...
	<span><h3><center>&nbsp;&nbsp;&nbsp;&nbsp;Click below to explore more </h3></span> </div>
		<div class="tbox1"><td><a href="readings.php?language=english&type=nutrition"><img src="images/readings.png" width="250" height="250" alt="" /></a></td></div>
